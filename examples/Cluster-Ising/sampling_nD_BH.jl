...
pred_SL_opt, indicator_SL_opt_classes, indicator_SL_opt_global = GCPT.run_scheme_1(x_data, class_data, [dp1, dp2])
pred_SL_opt_est, indicator_SL_opt_classes_est, indicator_SL_opt_global_est = GCPT.run_scheme_1(x_data,class_data_prob,[dp1,dp2],1000)
...
pred_est, std_est, I_3_est = GCPT.run_scheme_3(x_data[:,17,:],p_data[:,17,1],[dp1],5000)
...
I_2 = GCPT.run_scheme_2(x_data, l_param, p1_range, p1_range_LBC, p2_range, p2_range_LBC, [dp1,dp2])
I_2_est = GCPT.run_scheme_2(x_data, l_param, p1_range, p1_range_LBC, p2_range, p2_range_LBC, [dp1,dp2], 10)
...
I_2_est = GCPT.run_scheme_2(x_data[:,i,:], l_param, p1_range, p1_range_LBC, [dp1], n_samples)
