...
# Here, we approximate expected values with sample means. For routines which compute expected values exactly, as was done for Fig. 2 in the main text (as well as Fig. 2 in the SM), see script `run_main_2D.jl`.
...
#savefig("./results_ising_2D_scheme_1_w_sample_mean.png")
...
xlims!((γ1_range[2], γ1_range[end - 1]))
ylims!((γ2_range[2], γ2_range[end - 1]))
#savefig("./results_ising_2D_scheme_2_w_sample_mean.png")
...
xlims!((γ1_range[2], γ1_range[end - 1]))
ylims!((γ2_range[2], γ2_range[end - 1]))
#savefig("./results_ising_2D_scheme_3_w_sample_mean.png")
